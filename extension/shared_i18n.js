...
if (typeof globalThis._vt_i18n_loaded === 'undefined') {
    ...
    const VT_I18N = {
        "en": {
            ...
            msgSaved: "✅ Saved",
            forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ Data Cleared",
            ...
            modalClearDesc: "Are you sure you want to delete all watch records?<br>(Settings will be preserved)",
            modalImport: "📥 Import Backup",
            modalImportDesc: "This will overwrite your current records. Continue?",
            modalSetPass: "🔐 Setup Passcode",
            modalSetPassDesc: "Set a new passcode (leave blank to remove lock).<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ Warning: If you forget your passcode, the only way to recover is to WIPE ALL DATA.</span>",
            modalRescue: "🔑 Rescue Unlock",
            modalRescueDesc: "Enter your license key to reset passcode.<br><br>💡 Passcode will be cleared upon success.",
            modalEnterKey: "Enter your license key:",
...
,
            ...
            exportCoreData: "Export Core Data (Settings, Bookmarks, Rules)",
            exportImages: "Export All Bookmark Images (Auto-split into multiple files)",
            noImagesFound: "No separated images found (Older ones might be in Core Data)",
            backupCenterTitle: "Backup & Restore Center",
            backupCenterDesc: "Please wait while the operation completes. Do not close this tab.",
            closeTab: "Close Tab",
            initializing: "Initializing... Please wait",
            compressingZip: "Compressing ZIP file...",
            backupFailed: "Export Failed",
            readingFile: "Reading file...",
            extractingZip: "Extracting ZIP archive...",
            importFailed: "Import Failed",
            statusSelectFile: "Please select a backup file to import",
            btnSelectFile: "Select Backup File",
            importProgress: "Importing backup... {percent}%",
            importingFile: "Reading file {current}/{total}...",
            msgExportImagesPart: "Exporting Images Part {part}...",
            ...
            bvToastMoved: "✅ Bookmark moved", bvMoveFolder: "Move Folder", bvToastMovedFolder: "✅ Folder moved",
        ...
        "zh-TW": {
            ...
            msgProOnlyDesc: "請先升級至 V-Train 才能解鎖此進階功能。", msgSaved: "✅ 已儲存", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ 資料已清除",
            msgImportSuccess: "✅ 匯入成功！重新載入中...", msgImportFail: "❌ 格式錯誤", modalEnablePro: "⚡ 啟用 V-Train",
            modalEnterKey: "請輸入您的授權序號：", modalSetPass: "🔐 設定密碼", modalSetPassDesc: "設定新密碼 (留空則移除鎖定)。<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ 警告：若忘記密碼，唯一的解決方法是「清除所有資料」。請謹慎設定。</span>",
            modalClearData: "⚠️ 清除資料", modalClearDesc: "確定刪除所有觀看紀錄？<br>(設定將會保留)",
...
,
            ...
            bvList: "列表檢視",
            clickToHeal: "點擊修復",
            exportCoreData: "匯出核心資料 (設定、書籤、規則)",
            exportImages: "匯出所有書籤圖片 (將自動分批下載)",
            noImagesFound: "找不到獨立圖片 (舊圖片已包含在核心資料中)",
            backupCenterTitle: "備份與還原中心",
            backupCenterDesc: "作業進行中請稍候，請勿關閉此分頁。",
            closeTab: "關閉分頁",
            initializing: "初始化中...請稍候",
            compressingZip: "正在壓縮 ZIP 檔案...",
            backupFailed: "匯出失敗",
            readingFile: "正在讀取檔案...",
            extractingZip: "正在解壓縮 ZIP...",
            importFailed: "匯入失敗",
            statusSelectFile: "請選擇要匯入的備份檔案",
            btnSelectFile: "選擇備份檔案",
            importProgress: "正在匯入備份... {percent}%",
            importingFile: "讀取檔案 {current}/{total}...",
            msgExportImagesPart: "正在匯出圖片備份 第 {part} 份...",
            ...
            bvToastMoved: "✅ 書籤已移動", bvMoveFolder: "移動資料夾", bvToastMovedFolder: "✅ 資料夾已移動",
            bvMoveTitle: "🗂 移動書籤",
            bvBtnMove: "確認移動",
            btnLike: "喜歡",
            btnDislike: "不喜歡",
        ...
        "zh-CN": {
            ...
            msgProOnlyDesc: "请先升级至 V-Train 才能解锁此进阶功能。", msgSaved: "✅ 已保存", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ 数据已清除",
            msgImportSuccess: "✅ 导入成功！重新加载中...", msgImportFail: "❌ 格式错误", modalEnablePro: "⚡ 启用 V-Train",
            modalEnterKey: "请输入您的授权序列号：", modalSetPass: "🔐 设置密码", modalSetPassDesc: "设置新密码 (留空则移除锁定)。<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ 警告：若忘记密码，唯一的解决方法是“清除所有数据”。请谨慎设置。</span>",
            modalClearData: "⚠️ 清除数据", modalClearDesc: "确定删除所有观看记录？<br>(设置将会保留)",
...
,
            ...
            bvList: "列表视图",
            clickToHeal: "点击修复",
            exportCoreData: "导出核心数据 (设置、书签、规则)",
            exportImages: "导出所有书签图片 (将自动分批下载)",
            noImagesFound: "未找到独立图片 (旧图片已包含在核心数据中)",
            backupCenterTitle: "备份与还原中心",
            backupCenterDesc: "作业进行中请稍候，请勿关闭此标签页。",
            closeTab: "关闭标签页",
            initializing: "初始化中...请稍候",
            compressingZip: "正在压缩 ZIP 文件...",
            backupFailed: "导出失败",
            readingFile: "正在读取文件...",
            extractingZip: "正在解压缩 ZIP...",
            importFailed: "导入失败",
            statusSelectFile: "请选择要导入的备份文件",
            btnSelectFile: "选择备份文件",
            importProgress: "正在导入备份... {percent}%",
            importingFile: "读取文件 {current}/{total}...",
            msgExportImagesPart: "正在导出图片备份 第 {part} 份...",
            ...
            bvToastMoved: "✅ 书签已移动", bvMoveFolder: "移动文件夹", bvToastMovedFolder: "✅ 文件夹已移动",
            bvMoveTitle: "🗂 移动书签",
            bvBtnMove: "确认移动",
            btnLike: "喜欢",
            btnDislike: "不喜欢",
        ...
        "ja": {
            ...
            msgProOnlyDesc: "この高度な機能のロックを解除するには、V-Trainにアップグレードしてください。", msgSaved: "✅ 保存しました", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ データを消去しました",
            msgImportSuccess: "✅ インポート成功！リロード中...", msgImportFail: "❌ フォーマットエラー", modalEnablePro: "⚡ V-Trainを有効化",
            modalEnterKey: "ライセンスキーを入力してください:", modalSetPass: "🔐 パスコード設定", modalSetPassDesc: "新しいパスコードを設定 (空欄でロック解除)。<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ 警告: パスワードを忘れた場合、すべてのデータを消去するしか回復方法はありません。</span>",
...
,
            ...
            exportCoreData: "コアデータをエクスポート (設定、ブックマーク、ルール)",
            exportImages: "すべてのブックマーク画像をエクスポート (自動分割)",
            noImagesFound: "画像が見つかりません (古い画像はコアデータに含まれています)",
            backupCenterTitle: "バックアップと復元センター",
            backupCenterDesc: "処理が完了するまでお待ちください。このタブを閉じないでください。",
            closeTab: "タブを閉じる",
            initializing: "初期化中...お待ちください",
            compressingZip: "ZIPファイルを圧縮中...",
            backupFailed: "エクスポートに失敗しました",
            readingFile: "ファイルを読み込み中...",
            extractingZip: "ZIPを展開中...",
            importFailed: "インポートに失敗しました",
            statusSelectFile: "インポートするバックアップファイルを選択してください",
            btnSelectFile: "ファイルを選択",
            importProgress: "バックアップをインポートしています... {percent}%",
            importingFile: "ファイルを読み込んでいます {current}/{total}...",
            msgExportImagesPart: "画像エクスポート 第{part}部...",
            ...
            bvToastMoved: "✅ ブックマークを移動しました", bvMoveFolder: "フォルダを移動", bvToastMovedFolder: "✅ フォルダを移動しました",
        ...
        "ko": {
            ...
            msgProOnlyDesc: "이 고급 기능을 잠금 해제하려면 V-Train로 업그레이드하세요.", msgSaved: "✅ 저장됨", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ 데이터 삭제됨",
            msgImportSuccess: "✅ 가져오기 성공! 다시 로드 중...", msgImportFail: "❌ 형식 오류", modalEnablePro: "⚡ V-Train 활성화",
            modalEnterKey: "라이선스 키를 입력하세요:", modalSetPass: "🔐 비밀번호 설정", modalSetPassDesc: "새 비밀번호 설정 (잠금을 해제하려면 비워 두세요).<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ 경고: 비밀번호를 잊어버리면 데이터를 모두 지우는 것 외에 복구할 방법이 없습니다.</span>",
...
,
            ...
            bvList: "목록 보기",
            clickToHeal: "클릭하여 복구",
            exportCoreData: "핵심 데이터 내보내기 (설정, 북마크, 규칙)",
            exportImages: "모든 북마크 이미지 내보내기 (자동 분할)",
            noImagesFound: "이미지를 찾을 수 없습니다 (이전 이미지는 핵심 데이터에 포함되어 있습니다)",
            backupCenterTitle: "백업 및 복원 센터",
            backupCenterDesc: "작업이 완료될 때까지 기다려 주십시오. 이 탭을 닫지 마십시오.",
            closeTab: "탭 닫기",
            initializing: "초기화 중... 잠시 기다려 주십시오",
            compressingZip: "ZIP 파일 압축 중...",
            backupFailed: "내보내기 실패",
            readingFile: "파일 읽는 중...",
            extractingZip: "ZIP 압축 푸는 중...",
            importFailed: "가져오기 실패",
            statusSelectFile: "가져올 백업 파일을 선택하십시오",
            btnSelectFile: "파일 선택",
            importProgress: "백업 가져오는 중... {percent}%",
            importingFile: "파일 읽는 중 {current}/{total}...",
            msgExportImagesPart: "이미지 내보내기 {part} 부분...",
            ...
            bvToastMoved: "✅ 북마크가 이동되었습니다", bvMoveFolder: "폴더 이동", bvToastMovedFolder: "✅ 폴더가 이동되었습니다",
            bvMoveTitle: "🗂 북마크 이동",
            bvBtnMove: "이동 확인",
            btnLike: "좋아요",
            btnDislike: "싫어요",
        ...
        "es": {
            ...
            msgProOnlyDesc: "Actualice a V-Train para desbloquear esta función avanzada.", msgSaved: "✅ Guardado", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ Datos Borrados",
            msgImportSuccess: "✅ ¡Importación Exitosa! Recargando...", msgImportFail: "❌ Error de Formato", modalEnablePro: "⚡ Activar V-Train",
            modalEnterKey: "Ingrese su clave de licencia:", modalSetPass: "🔐 Configurar Código", modalSetPassDesc: "Establecer nuevo código (vacío para eliminar).<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ Advertencia: Si olvida su contraseña, la única forma de recuperarse es BORRAR TODOS LOS DATOS.</span>",
...
,
            ...
            exportCoreData: "Exportar datos principales (Ajustes, Marcadores)",
            exportImages: "Exportar todas las imágenes de marcadores",
            noImagesFound: "No se encontraron imágenes (las antiguas están en los datos principales)",
            backupCenterTitle: "Centro de Copia de Seguridad y Restauración",
            backupCenterDesc: "Por favor, espere mientras se completa la operación. No cierre esta pestaña.",
            closeTab: "Cerrar Pestaña",
            initializing: "Inicializando... Por favor espere",
            compressingZip: "Comprimiendo archivo ZIP...",
            backupFailed: "Error al exportar",
            readingFile: "Leyendo archivo...",
            extractingZip: "Extrayendo archivo ZIP...",
            importFailed: "Error al importar",
            statusSelectFile: "Seleccione un archivo de copia de seguridad para importar",
            btnSelectFile: "Seleccionar archivo",
            importProgress: "Importando copia... {percent}%",
            importingFile: "Leyendo archivo {current}/{total}...",
            msgExportImagesPart: "Exportando imágenes parte {part}...",
            ...
            bvToastMoved: "✅ Marcador movido", bvMoveFolder: "Mover Carpeta", bvToastMovedFolder: "✅ Carpeta movida",
        ...
        "fr": {
            ...
            msgProOnlyDesc: "Veuillez passer à V-Train pour débloquer cette fonctionnalité avancée.", msgSaved: "✅ Enregistré", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ Données effacées",
            msgImportSuccess: "✅ Importation réussie ! Rechargement...", msgImportFail: "❌ Erreur de format", modalEnablePro: "⚡ Activer V-Train",
            modalEnterKey: "Veuillez entrer votre clé de licence :", modalSetPass: "🔐 Définir le code", modalSetPassDesc: "Définir un nouveau code (laisser vide pour supprimer).<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ Attention : Si vous oubliez votre mot de passe, le seul moyen de le récupérer est d'EFFACER TOUTES LES DONNÉES.</span>",
...
,
            ...
            exportCoreData: "Exporter les données principales",
            exportImages: "Exporter toutes les images des signets",
            noImagesFound: "Aucune image trouvée (les anciennes sont dans les données principales)",
            backupCenterTitle: "Centre de Sauvegarde et Restauration",
            backupCenterDesc: "Veuillez patienter pendant que l'opération se termine. Ne fermez pas cet onglet.",
            closeTab: "Fermer l'onglet",
            initializing: "Initialisation... Veuillez patienter",
            compressingZip: "Compression du fichier ZIP...",
            backupFailed: "Échec de l'exportation",
            readingFile: "Lecture du fichier...",
            extractingZip: "Extraction de l'archive ZIP...",
            importFailed: "Échec de l'importation",
            statusSelectFile: "Veuillez sélectionner un fichier de sauvegarde à importer",
            btnSelectFile: "Sélectionner un fichier",
            importProgress: "Importation de la sauvegarde... {percent}%",
            importingFile: "Lecture du fichier {current}/{total}...",
            msgExportImagesPart: "Exportation d'images partie {part}...",
            ...
            bvToastMoved: "✅ Favori déplacé", bvMoveFolder: "Déplacer le dossier", bvToastMovedFolder: "✅ Dossier déplacé",
        ...
        "de": {
            ...
            msgProOnlyDesc: "Bitte auf V-Train aktualisieren, um diese erweiterte Funktion freizuschalten.", msgSaved: "✅ Gespeichert", forgotPassWipe: "Forgot Passcode? (Wipe all data)", msgCleared: "✅ Daten gelöscht",
            msgImportSuccess: "✅ Import erfolgreich! Wird neu geladen...", msgImportFail: "❌ Formatfehler", modalEnablePro: "⚡ V-Train aktivieren",
            modalEnterKey: "Bitte geben Sie Ihren Lizenzschlüssel ein:", modalSetPass: "🔐 Passcode setzen", modalSetPassDesc: "Neuen Passcode setzen (leer lassen zum Entfernen).<br><br><span style='color:#ff4444; font-weight:bold;'>⚠️ Warnung: Wenn Sie Ihr Passwort vergessen, können Sie es nur durch LÖSCHEN ALLER DATEN wiederherstellen.</span>",
            modalClearData: "⚠️ Daten löschen", modalClearDesc: "Sind Sie sicher, dass Sie den Verlauf löschen wollen?<br>(Einstellungen bleiben erhalten)",
...
,
            ...
            exportCoreData: "Kerndaten exportieren",
            exportImages: "Alle Lesezeichen-Bilder exportieren",
            noImagesFound: "Keine Bilder gefunden (ältere befinden sich in den Kerndaten)",
            backupCenterTitle: "Sicherungs- und Wiederherstellungszentrum",
            backupCenterDesc: "Bitte warten Sie, bis der Vorgang abgeschlossen ist. Schließen Sie diesen Tab nicht.",
            closeTab: "Tab schließen",
            initializing: "Initialisierung... Bitte warten",
            compressingZip: "ZIP-Datei wird komprimiert...",
            backupFailed: "Export fehlgeschlagen",
            readingFile: "Datei wird gelesen...",
            extractingZip: "ZIP-Archiv wird entpackt...",
            importFailed: "Import fehlgeschlagen",
            statusSelectFile: "Bitte wählen Sie eine Sicherungsdatei zum Importieren aus",
            btnSelectFile: "Datei auswählen",
            importProgress: "Backup importieren... {percent}%",
            importingFile: "Lese Datei {current}/{total}...",
            msgExportImagesPart: "Bilder exportieren Teil {part}..."
