...
,
        ...
        "zh-TW": {
            ...
            modalEnterKey: "請輸入您的授權序號：", modalSetPass: "🔐 設定密碼", modalSetPassDesc: "設定新密碼 (留空則移除鎖定)。<br><br><span style='color:#ff4444;font-size:12px;'>⚠️ 警告：若忘記密碼，唯一的解決方法是「清除所有資料」。請謹慎設定。</span>",
...
,
        ...
        "zh-CN": {
            ...
            modalEnterKey: "请输入您的授权序列号：", modalSetPass: "🔐 设置密码", modalSetPassDesc: "设置新密码 (留空则移除锁定)。<br><br><span style='color:#ff4444;font-size:12px;'>⚠️ 警告：若忘记密码，唯一的解决方法是“清除所有数据”。请谨慎设置。</span>",
...
,
        ...
        "de": {
            ...
            modalEnterKey: "Bitte geben Sie Ihren Lizenzschlüssel ein:", modalSetPass: "🔐 Passcode setzen", modalSetPassDesc: "Neuen Passcode setzen (leer lassen zum Entfernen).<br><br><span style='color:#ff4444;font-size:12px;'>⚠️ Warnung: Wenn Sie Ihr Passwort vergessen, können Sie es nur durch LÖSCHEN ALLER DATEN wiederherstellen.</span>",
